...
mysql -h kiirtidb.c4iuunoxp2j3.us-east-1.rds.amazonaws.com -uemoksha -p mhidb --skip-column-names -e "call upd_SMSID_In_SitesTable();" >> /root/kiirti/multiple/mog/Ushahidi_MHI/log/kiirti_SMSID_Creation.log 2>&1
