...
class Mhi_Auth_User_Model extends ORM {
	...
	public function validate(array & $array, $save = FALSE)
	{
		$array = Validation::factory($array)
			->pre_filter('trim')
			->add_rules('email', 'required', 'length[4,127]', 'valid::email', array($this, 'email_exists'))
			->add_rules('username', 'required', 'length[6,32]', 'chars[a-zA-Z0-9_]', array($this, 'username_exists'))
