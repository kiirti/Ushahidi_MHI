...
<body>
  <div id="page-container">
	...
	<!--<div id=main-nav">
	 <ul>
	   <li id="home"><a href="/main"></li>
	   <li id="whatis"><a href="/static/view/whatiskiirti"></li>
	   <li id="supportedcauses"><a href="/static/view/supportedcauses"></li>
           <li id="getinvolved"><a href="/static/view/getinvolved"></li>
	   <li id="faq"><a href="/static/view/faq"></li>
	   <li id="aboutkiirti"><a href="/static/view/aboutkiirti"></li>
	</div>-->
...
<tr>
	...
	<!-- kiirti menu -->
	<img src="/media/img/box.gif" width= 20>
        <a href="/main">
	<img src="/media/img/btn_kiirtihome_default.png" border= 0>
	</a>
